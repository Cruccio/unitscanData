...
OUTPUT_TABLE["The Hinterlands"] = {
	...
	{active=true, text=L["Ironback"], check=false, id=8213, cls=4},
	{active=true, text=L["Retherokk the Berserker"], check=false, id=8216, cls=4},
	{active=true, text=L["Old Cliff Jumper"], check=false, id=8211, cls=4},
	{active=true, text=L["Zul'arek Hatefowler"], check=false, id=8219, cls=4},
	{active=true, text=L["The Reak"], check=false, id=8212, cls=4},
	{active=true, text=L["Witherheart the Stalker"], check=false, id=8218, cls=4},
	{active=true, text=L["Razortalon"], check=false, id=8210, cls=4},
...
OUTPUT_TABLE["Stranglethorn Vale"] = {
	...
	{active=true, text=L["Scale Belly"], check=false, id=1552, cls=4},
	{active=true, text=L["Rippa"], check=false, id=14490, cls=4},
	{active=true, text=L["Lord Sakrasis"], check=false, id=2541, cls=4},
	{active=true, text=L["Kurmokk"], check=false, id=14491, cls=4},
	{active=true, text=L["Verifonix"], check=false, id=14492, cls=4},
	{active=true, text=L["Gluggle"], check=false, id=14487, cls=4},
	{active=true, text=L["Roloch"], check=false, id=14488, cls=4},
}
for i=41,75 do
...
OUTPUT_TABLE["Duskwood"] = {
	...
	{active=true, text=L["Morbent Fel"], check=true, id=1200, cls=1},
	{active=true, text=L["Eliza"], check=true, id=314, cls=1},
...
OUTPUT_TABLE["Arathi Highlands"] = {
	{active=true, text=L["Fozruk"], check=true, id=2611, cls=1},
	{active=true, text=L["Marez Cowl"], check=true, id=2783, cls=1},
	{active=true, text=L["Myzrael"], check=true, id=2755, cls=1},
	...
	{active=true, text=L["Prince Nazjak"], check=false, id=2779, cls=4},
	{active=true, text=L["Nimar the Slayer"], check=false, id=2606, cls=4},
	{active=true, text=L["Kovork"], check=false, id=2603, cls=4},
	{active=true, text=L["Singer"], check=false, id=2600, cls=4},
	{active=true, text=L["Molok the Crusher"], check=false, id=2604, cls=4},
...
OUTPUT_TABLE["Alterac Mountains"] = {
	...
	{active=true, text=L["Lo'Grosh"], check=false, id=2453, cls=4},
	{active=true, text=L["Araga"], check=false, id=14222, cls=4},
	{active=true, text=L["Skhowl"], check=false, id=2452, cls=4},
	{active=true, text=L["Cranky Benj"], check=false, id=14223, cls=4},
	{active=true, text=L["Gravis Slipknot"], check=false, id=14221, cls=4},
	{active=true, text=L["Stone Fury"], check=false, id=2258, cls=4},
	{active=true, text=L["Jimmy the Bleeder"], check=false, id=14281, cls=4},
}
for i=30,75 do
...
OUTPUT_TABLE["Winterspring"] = {
	...
	{active=true, text=L["Shadow of Doom"], check=true, id=16143, cls=1},
	...
	{active=true, text=L["Rak'shiri"], check=false, id=10200, cls=4},
	{active=true, text=L["Grizzle Snowpaw"], check=false, id=10199, cls=4},
	{active=true, text=L["Mezzir the Howler"], check=false, id=10197, cls=4},
}
for i=32,75 do
...
OUTPUT_TABLE["Dustwallow Marsh"] = {
	...
	{active=true, text=L["Ripscale"], check=false, id=14233, cls=4},
	{active=true, text=L["Burgle Eye"], check=false, id=14230, cls=4},
	{active=true, text=L["Dart"], check=false, id=14232, cls=4},
	{active=true, text=L["Darkmist Widow"], check=false, id=4380, cls=4},
	{active=true, text=L["Hayoc"], check=false, id=14234, cls=4},
	{active=true, text=L["Drogoth the Roamer"], check=false, id=14231, cls=4},
	{active=true, text=L["Lord Angler"], check=false, id=14236, cls=4},
	{active=true, text=L["Oozeworm"], check=false, id=14237, cls=4},
	{active=true, text=L["The Rot"], check=false, id=14235, cls=4},
}
for i=27,75 do
...
OUTPUT_TABLE["The Barrens"] = {
	...
	{active=true, text=L["Qiraji Officer Zod"], check=false, id=15813, cls=1},
	...
	{active=true, text=L["Warlord Krom'zar"], check=true, id=9456, cls=1},
	{active=true, text=L["Deviate Coiler"], check=true, id=3630, cls=1},
	{active=true, text=L["Sand Shark"], check=true, id=5435, cls=1},
	{active=true, text=L["Grand Foreman Puzik Gallywix"], check=true, id=7288, cls=1},
	...
	{active=true, text=L["Faltering Silithid Flayer"], check=true, id=15811, cls=1},
	...
	{active=true, text=L["Minor Silithid Flayer"], check=true, id=15808, cls=1},
	...
	{active=true, text=L["Swiftmane"], check=true, id=5831, cls=2},
	...
	{active=true, text=L["Elder Mystic Razorsnout"], check=true, id=3270, cls=2},
	{active=true, text=L["Swinegart Spearhide"], check=true, id=5864, cls=2},
	{active=true, text=L["Brontus"], check=true, id=5827, cls=2},
	...
	{active=true, text=L["Captain Gerogg Hammertoe"], check=true, id=5851, cls=2},
	...
	{active=true, text=L["Snort the Heckler"], check=false, id=5829, cls=4},
	{active=true, text=L["Azzere the Skyblade"], check=false, id=5834, cls=4},
	{active=true, text=L["Rathorian"], check=false, id=3470, cls=4},
	{active=true, text=L["Engineer Whirleygig"], check=false, id=5836, cls=4},
	{active=true, text=L["Thunderstomp"], check=false, id=5832, cls=4},
	{active=true, text=L["Sludge Beast"], check=false, id=3295, cls=4},
	{active=true, text=L["Stonearm"], check=false, id=5837, cls=4},
	{active=true, text=L["Foreman Grills"], check=false, id=5835, cls=4},
	{active=true, text=L["Brokespear"], check=false, id=5838, cls=4},
...
OUTPUT_TABLE["Thousand Needles"] = {
	...
	{active=true, text=L["Arikara"], check=true, id=10882, cls=1},
	{active=true, text=L["Lesser Anubisath Warbringer"], check=false, id=15748, cls=1},
	{active=true, text=L["Razorfen Thornweaver"], check=true, id=7874, cls=1},
	{active=true, text=L["Death's Head Cultist"], check=true, id=7872, cls=1},
	{active=true, text=L["Lesser Silithid Flayer"], check=true, id=15749, cls=1},
	{active=true, text=L["Nyse"], check=false, id=4317, cls=1},
	{active=true, text=L["Young Arikara"], check=true, id=10581, cls=1},
	{active=true, text=L["Enraged Panther"], check=true, id=10992, cls=1},
	{active=true, text=L["Qiraji Major"], check=false, id=15750, cls=1},
	{active=true, text=L["Anubisath Warbringer"], check=false, id=15751, cls=1},
	{active=true, text=L["Qiraji Captain"], check=false, id=15747, cls=1},
	...
	{active=true, text=L["Achellios the Banished"], check=false, id=5933, cls=4},
	{active=true, text=L["Silithid Ravager"], check=false, id=4132, cls=4},
	{active=true, text=L["Gibblesnik"], check=false, id=14427, cls=4},
...
OUTPUT_TABLE["Un'Goro Crater"] = {
	...
	{active=true, text=L["Stone Guardian"], check=true, id=6560, cls=1},
	{active=true, text=L["King Mosh"], check=true, id=6584, cls=2},
	{active=true, text=L["Gruff"], check=true, id=6583, cls=2},
	{active=true, text=L["Uhk'loc"], check=false, id=6585, cls=4},
	{active=true, text=L["Ravasaur Matriarch"], check=false, id=6581, cls=4},
	{active=true, text=L["Clutchmother Zavas"], check=false, id=6582, cls=4},
}
for i=16,75 do
...
OUTPUT_TABLE["Elwynn Forest"] = {
	...
	{active=true, text=L["Rogue Black Drake"], check=true, id=14388, cls=1},
...
OUTPUT_TABLE["Durotar"] = {
	...
	{active=true, text=L["Steamwheedle Bruiser"], check=false, id=16096, cls=1},
	{active=true, text=L["Felweaver Scornn"], check=true, id=5822, cls=2},
	{active=true, text=L["Captain Flat Tusk"], check=true, id=5824, cls=2},
...
OUTPUT_TABLE["Tirisfal Glades"] = {
	...
	{active=true, text=L["Fellicent's Shade"], check=false, id=10358, cls=4},
...
OUTPUT_TABLE["Searing Gorge"] = {
	...
	{active=true, text=L["Rekk'tilac"], check=false, id=8277, cls=4},
	{active=true, text=L["Shleipnarr"], check=false, id=8280, cls=4},
	{active=true, text=L["Smoldar"], check=false, id=8278, cls=4},
	{active=true, text=L["Slave Master Blackheart"], check=false, id=8283, cls=4},
	{active=true, text=L["Faulty War Golem"], check=false, id=8279, cls=4},
	{active=true, text=L["Scald"], check=false, id=8281, cls=4},
}
for i=22,75 do
...
OUTPUT_TABLE["Loch Modan"] = {
	...
	{active=true, text=L["Chok'sul"], check=true, id=1210, cls=1},
	{active=true, text=L["Haren Swifthoof"], check=false, id=2478, cls=1},
	{active=true, text=L["Mo'grosh Ogre"], check=true, id=1178, cls=1},
	{active=true, text=L["Mo'grosh Brute"], check=true, id=1180, cls=1},
	{active=true, text=L["Gradok"], check=true, id=2477, cls=1},
	{active=true, text=L["Thragomm"], check=true, id=7170, cls=1},
	{active=true, text=L["Thorgrum Borrelson"], check=false, id=1572, cls=1},
	{active=true, text=L["Mo'grosh Enforcer"], check=true, id=1179, cls=1},
	{active=true, text=L["Mo'grosh Shaman"], check=true, id=1181, cls=1},
	{active=true, text=L["Mo'grosh Mystic"], check=true, id=1183, cls=1},
	{active=true, text=L["Emogg the Crusher"], check=true, id=14267, cls=2},
	...
	{active=true, text=L["Large Loch Crocolisk"], check=false, id=2476, cls=4},
}
for i=19,75 do
...
OUTPUT_TABLE["Dun Morogh"] = {
	{active=true, text=L["Vagash"], check=true, id=1388, cls=1},
	{active=true, text=L["Old Icebeard"], check=true, id=1271, cls=1},
...
OUTPUT_TABLE["Westfall"] = {
	...
	{active=true, text=L["Klaven Mortwake"], check=true, id=7053, cls=1},
	...
	{active=true, text=L["Foe Reaper 4000"], check=false, id=573, cls=4},
	{active=true, text=L["Brack"], check=false, id=520, cls=4},
	{active=true, text=L["Leprithus"], check=false, id=572, cls=4},
	{active=true, text=L["Slark"], check=false, id=519, cls=4},
...
OUTPUT_TABLE["Desolace"] = {
	...
	{active=true, text=L["Prince Kellen"], check=false, id=14225, cls=4},
	{active=true, text=L["Kaskk"], check=false, id=14226, cls=4},
	{active=true, text=L["Giggler"], check=false, id=14228, cls=4},
	{active=true, text=L["Hissperak"], check=false, id=14227, cls=4},
	{active=true, text=L["Accursed Slitherblade"], check=false, id=14229, cls=4},
	{active=true, text=L["Cursed Centaur"], check=false, id=11688, cls=4},
}
for i=23,75 do
...
OUTPUT_TABLE["Wetlands"] = {
	...
	{active=true, text=L["Hammerhead Shark"], check=true, id=5185, cls=1},
	{active=true, text=L["Dark Iron Saboteur"], check=true, id=1052, cls=1},
	...
	{active=true, text=L["Leech Widow"], check=false, id=1112, cls=4},
	...
	{active=true, text=L["Dragonmaw Battlemaster"], check=false, id=1037, cls=4},
...
OUTPUT_TABLE["Hillsbrad Foothills"] = {
	{active=true, text=L["Captain Ironhill"], check=true, id=2304, cls=1},
	{active=true, text=L["Cyclonian"], check=true, id=6239, cls=1},
	...
	{active=true, text=L["Narillasanz"], check=true, id=2447, cls=2},
	{active=true, text=L["Tamra Stormpike"], check=true, id=14275, cls=2},
	{active=true, text=L["Big Samras"], check=false, id=14280, cls=4},
	{active=true, text=L["Scargil"], check=false, id=14276, cls=4},
	{active=true, text=L["Lady Zephris"], check=false, id=14277, cls=4},
	{active=true, text=L["Creepthess"], check=false, id=14279, cls=4},
	{active=true, text=L["Ro'Bark"], check=false, id=14278, cls=4},
}
for i=30,75 do
...
OUTPUT_TABLE["Stonetalon Mountains"] = {
	...
	{active=true, text=L["Goggeroc"], check=true, id=11920, cls=1},
	...
	{active=true, text=L["Nal'taszar"], check=true, id=4066, cls=2},
	{active=true, text=L["Sister Riven"], check=true, id=5930, cls=2},
	{active=true, text=L["Brother Ravenoak"], check=true, id=5915, cls=2},
	{active=true, text=L["Sentinel Amarassan"], check=true, id=5916, cls=2},
	{active=true, text=L["Pridewing Patriarch"], check=false, id=4015, cls=4},
	{active=true, text=L["Vengeful Ancient"], check=false, id=4030, cls=4},
}
for i=22,75 do
...
OUTPUT_TABLE["Redridge Mountains"] = {
	...
	{active=true, text=L["Tharil'zun"], check=true, id=486, cls=1},
	{active=true, text=L["Singe"], check=true, id=335, cls=1},
	{active=true, text=L["Blackrock Shadowcaster"], check=true, id=436, cls=1},
	{active=true, text=L["Morganth"], check=true, id=397, cls=1},
	...
	{active=true, text=L["Snarlflare"], check=false, id=14272, cls=4},
...
OUTPUT_TABLE["Burning Steppes"] = {
	...
	{active=true, text=L["Deathmaw"], check=false, id=10077, cls=4},
	{active=true, text=L["Bone Witch"], check=false, id=16380, cls=4},
	{active=true, text=L["Lumbering Horror"], check=false, id=14697, cls=4},
	{active=true, text=L["Gruklash"], check=false, id=8979, cls=4},
	{active=true, text=L["Hahk'Zor"], check=false, id=9602, cls=4},
	{active=true, text=L["Spirit of the Damned"], check=false, id=16379, cls=4},
	{active=true, text=L["Terrorspark"], check=false, id=10078, cls=4},
	{active=true, text=L["Malfunctioning Reaver"], check=false, id=8981, cls=4},
	{active=true, text=L["Thauris Balgarr"], check=false, id=8978, cls=4},
	{active=true, text=L["Gorgon'och"], check=false, id=9604, cls=4},
}
for i=31,75 do
...
OUTPUT_TABLE["Azshara"] = {
	...
	{active=true, text=L["Shadow of Doom"], check=true, id=16143, cls=1},
	{active=true, text=L["Scalebeard"], check=true, id=13896, cls=2},
	...
	{active=true, text=L["General Fangferror"], check=false, id=6650, cls=4},
	{active=true, text=L["The Evalcharr"], check=false, id=8660, cls=4},
	{active=true, text=L["Master Feardred"], check=false, id=6652, cls=4},
	{active=true, text=L["Varo'then's Ghost"], check=false, id=6118, cls=4},
	{active=true, text=L["Lady Sesspira"], check=false, id=6649, cls=4},
	{active=true, text=L["Antilos"], check=false, id=6648, cls=4},
	{active=true, text=L["Magister Hawkhelm"], check=false, id=6647, cls=4},
}
for i=26,75 do
...
OUTPUT_TABLE["Ashenvale"] = {
	...
	{active=true, text=L["Mist Howler"], check=false, id=10644, cls=4},
	{active=true, text=L["Terrowulf Packlord"], check=false, id=3792, cls=4},
	{active=true, text=L["Ursol'lok"], check=false, id=12037, cls=4},
	{active=true, text=L["Lady Vespia"], check=false, id=10559, cls=4},
	{active=true, text=L["Mugglefin"], check=false, id=10643, cls=4},
	{active=true, text=L["Prince Raze"], check=false, id=10647, cls=4},
	{active=true, text=L["Akkrilus"], check=false, id=3773, cls=4},
	{active=true, text=L["Apothecary Falthis"], check=false, id=3735, cls=4},
	{active=true, text=L["Eck'alom"], check=false, id=10642, cls=4},
	{active=true, text=L["Rorgish Jowl"], check=false, id=10639, cls=4},
	{active=true, text=L["Branch Snapper"], check=false, id=10641, cls=4},
	{active=true, text=L["Oakpaw"], check=false, id=10640, cls=4},
}
for i=27,75 do
...
OUTPUT_TABLE["Eastern Plaguelands"] = {
	...
	{active=true, text=L["Lord Darkscythe"], check=false, id=10826, cls=4},
	...
	{active=true, text=L["Bone Witch"], check=false, id=16380, cls=4},
	{active=true, text=L["Hed'mush the Rotting"], check=false, id=10821, cls=4},
	{active=true, text=L["Deathspeaker Selendre"], check=false, id=10827, cls=4},
	{active=true, text=L["Lumbering Horror"], check=false, id=14697, cls=4},
	{active=true, text=L["Spirit of the Damned"], check=false, id=16379, cls=4},
	{active=true, text=L["Warlord Thresh'jin"], check=false, id=10822, cls=4},
	{active=true, text=L["Zul'Brin Warpbranch"], check=false, id=10823, cls=4},
	{active=true, text=L["Gish the Unmoving"], check=false, id=10825, cls=4},
}
for i=45,75 do
...
OUTPUT_TABLE["Badlands"] = {
	...
	{active=true, text=L["Broken Tooth"], check=false, id=2850, cls=4},
	{active=true, text=L["Rumbler"], check=false, id=2752, cls=4},
	{active=true, text=L["7:XT"], check=false, id=14224, cls=4},
	{active=true, text=L["War Golem"], check=false, id=2751, cls=4},
	{active=true, text=L["Shadowforge Commander"], check=false, id=2744, cls=4},
}
for i=20,75 do
...
OUTPUT_TABLE["Blasted Lands"] = {
	...
	{active=true, text=L["Grunter"], check=false, id=8303, cls=4},
	{active=true, text=L["Ravage"], check=false, id=8300, cls=4},
	{active=true, text=L["Clack the Reaver"], check=false, id=8301, cls=4},
	{active=true, text=L["Bone Witch"], check=false, id=16380, cls=4},
	{active=true, text=L["Dreadscorn"], check=false, id=8304, cls=4},
	{active=true, text=L["Lumbering Horror"], check=false, id=14697, cls=4},
	{active=true, text=L["Spirit of the Damned"], check=false, id=16379, cls=4},
	{active=true, text=L["Akubar the Seer"], check=false, id=8298, cls=4},
	{active=true, text=L["Deatheye"], check=false, id=8302, cls=4},
	{active=true, text=L["Mojo the Twisted"], check=false, id=8296, cls=4},
	{active=true, text=L["Magronos the Unyielding"], check=false, id=8297, cls=4},
}
for i=26,75 do
...
OUTPUT_TABLE["Silverpine Forest"] = {
	...
	{active=true, text=L["Thule Ravenclaw"], check=true, id=1947, cls=1},
	{active=true, text=L["Councilman Smithers"], check=true, id=2060, cls=1},
	{active=true, text=L["Pyrewood Leatherworker"], check=false, id=3532, cls=1},
	{active=true, text=L["Reef Shark"], check=true, id=12123, cls=1},
	{active=true, text=L["Moonrage Leatherworker"], check=true, id=3533, cls=1},
	{active=true, text=L["Lord Mayor Morrison"], check=true, id=2068, cls=1},
	...
	{active=true, text=L["Apothecary Berard"], check=true, id=2106, cls=1},
	...
	{active=true, text=L["Councilman Cooper"], check=true, id=2065, cls=1},
	{active=true, text=L["Councilman Thatcher"], check=true, id=2061, cls=1},
	{active=true, text=L["Councilman Wilhelm"], check=true, id=2063, cls=1},
	{active=true, text=L["Councilman Brunswick"], check=true, id=2067, cls=1},
	{active=true, text=L["Councilman Hartin"], check=true, id=2064, cls=1},
	{active=true, text=L["Councilman Hendricks"], check=true, id=2062, cls=1},
	{active=true, text=L["Pyrewood Watcher"], check=false, id=1891, cls=1},
	{active=true, text=L["Councilman Higarth"], check=true, id=2066, cls=1},
	...
	{active=true, text=L["Old Vicejaw"], check=false, id=12432, cls=4},
...
OUTPUT_TABLE["Feralas"] = {
	...
	{active=true, text=L["Arash-ethis"], check=false, id=5349, cls=4},
	{active=true, text=L["Snarler"], check=false, id=5356, cls=4},
	{active=true, text=L["Diamond Head"], check=false, id=5345, cls=4},
	{active=true, text=L["Old Grizzlegut"], check=false, id=5352, cls=4},
	{active=true, text=L["Qirot"], check=false, id=5350, cls=4},
	{active=true, text=L["Lady Szallah"], check=false, id=5343, cls=4},
	{active=true, text=L["Gnarl Leafbrother"], check=false, id=5354, cls=4},
	{active=true, text=L["Antilus the Soarer"], check=false, id=5347, cls=4},
	{active=true, text=L["Bloodroar the Stalker"], check=false, id=5346, cls=4},
}
for i=34,75 do
...
OUTPUT_TABLE["Tanaris"] = {
	...
	{active=true, text=L["Occulus"], check=true, id=8196, cls=1},
	{active=true, text=L["Tick"], check=true, id=8198, cls=1},
	...
	{active=true, text=L["Greater Silithid Flayer"], check=true, id=15756, cls=1},
	{active=true, text=L["Chronalis"], check=true, id=8197, cls=1},
	{active=true, text=L["Shadow of Doom"], check=true, id=16143, cls=1},
	{active=true, text=L["Qiraji Brigadier General Pax-lish"], check=false, id=15817, cls=1},
	{active=true, text=L["Greater Anubisath Warbringer"], check=false, id=15754, cls=1},
	{active=true, text=L["Qiraji Brigadier General"], check=false, id=15753, cls=1},
	...
	{active=true, text=L["Murderous Blisterpaw"], check=false, id=8208, cls=4},
	{active=true, text=L["Greater Firebird"], check=false, id=8207, cls=4},
	{active=true, text=L["Omgorn the Lost"], check=false, id=8201, cls=4},
	{active=true, text=L["Kregg Keelhaul"], check=false, id=8203, cls=4},
	{active=true, text=L["Soriid the Devourer"], check=false, id=8204, cls=4},
	{active=true, text=L["Haarka the Ravenous"], check=false, id=8205, cls=4},
	{active=true, text=L["Cyclok the Mad"], check=false, id=8202, cls=4},
}
for i=29,75 do
...
OUTPUT_TABLE["Felwood"] = {
	...
	{active=true, text=L["Death Howl"], check=false, id=14339, cls=4},
	{active=true, text=L["Mongress"], check=false, id=14344, cls=4},
	{active=true, text=L["Ragepaw"], check=false, id=14342, cls=4},
	{active=true, text=L["Alshirr Banebreath"], check=false, id=14340, cls=4},
	{active=true, text=L["The Ongar"], check=false, id=14345, cls=4},
}
for i=14,75 do
...
OUTPUT_TABLE["Western Plaguelands"] = {
	...
	{active=true, text=L["Lord Maldazzar"], check=false, id=1848, cls=4},
	{active=true, text=L["The Husk"], check=false, id=1851, cls=4},
	{active=true, text=L["Foreman Marcrid"], check=false, id=1844, cls=4},
	{active=true, text=L["Scarlet Judge"], check=false, id=1837, cls=4},
	{active=true, text=L["Scarlet Smith"], check=false, id=1885, cls=4},
	{active=true, text=L["Foulmane"], check=false, id=1847, cls=4},
}
for i=25,75 do
...
OUTPUT_TABLE["Teldrassil"] = {
	{active=true, text=L["Oakenscowl"], check=true, id=2166, cls=1},
...
OUTPUT_TABLE["Silithus"] = {
	...
	{active=true, text=L["Supreme Anubisath Warbringer"], check=false, id=15758, cls=1},
	...
	{active=true, text=L["Colossal Anubisath Warbringer"], check=false, id=15743, cls=1},
	...
	{active=true, text=L["Qiraji Drone"], check=false, id=15421, cls=1},
	...
	{active=true, text=L["Qiraji Tank"], check=false, id=15422, cls=1},
	{active=true, text=L["Imperial Qiraji Destroyer"], check=false, id=15744, cls=1},
	...
	{active=true, text=L["Qiraji Wasp"], check=false, id=15414, cls=1},
	...
	{active=true, text=L["Huricanian"], check=false, id=14478, cls=4},
	{active=true, text=L["Gretheer"], check=false, id=14472, cls=4},
	{active=true, text=L["Twilight Lord Everun"], check=false, id=14479, cls=4},
	{active=true, text=L["Grubthor"], check=false, id=14477, cls=4},
	{active=true, text=L["Krellack"], check=false, id=14476, cls=4},
}
for i=72,75 do
...
OUTPUT_TABLE["Swamp of Sorrows"] = {
	...
	{active=true, text=L["Molt Thorn"], check=false, id=14448, cls=4},
	{active=true, text=L["Lost One Chieftain"], check=false, id=763, cls=4},
	{active=true, text=L["Gilmorian"], check=false, id=14447, cls=4},
	{active=true, text=L["Lost One Cook"], check=false, id=1106, cls=4},
}
for i=11,75 do
...
OUTPUT_TABLE["Mulgore"] = {
	{active=true, text=L["Sister Hatelash"], check=true, id=5785, cls=2},
	{active=true, text=L["The Rake"], check=false, id=5807, cls=4},
	{active=true, text=L["Ghost Howl"], check=false, id=3056, cls=4},
	{active=true, text=L["Mazzranache"], check=false, id=3068, cls=4},
